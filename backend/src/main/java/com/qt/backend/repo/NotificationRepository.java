...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    @Query("SELECT new com.qt.backend.dto.NotificationDto(n.id, n.byUser.profilePicture , n.byUser.userId, n.byUser.username,n.byUser.isPrivate, n.type, n.createdAt) "
    + "FROM Notification n "
