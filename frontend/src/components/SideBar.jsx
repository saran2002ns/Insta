...
function SideBar({ onSearchClick, isSearchMode, onNotificationClick, isNotificationMode, onCloseOverlays }) {
  ...
  return (
    <div className={`flex flex-col h-screen fixed bg-white border-r border-gray-200 transition-all duration-300 ${
      ...
      {/* Instagram Logo */}
      <div className={`font-playwrite text-3xl font-bold p-3 hover:cursor-pointer border-b border-gray-100 flex items-center ${isCollapsed ? 'justify-center' : ''}`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8 mr-2">
